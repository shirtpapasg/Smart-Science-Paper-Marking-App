...
{
  id: 'p4-6-2', level: 'P4', chapter: 'Heat', code: '6.2', minutes: 35, kind: 'lab3d', status: 'ready',
  title: 'What makes the temperature change?',
  cc21: ['Critical Thinking', 'Communication'],
  skills: ['Using Models', 'Analysing Data', 'Communicating with Evidence'],
  bigIdea: 'When a hotter object touches a colder one, heat moves from the hotter object to the colder one. The hotter object loses heat and cools down; the colder object gains heat and warms up. The moving stops when both are at the same temperature.',
  aim: 'Lower a hot potato into cooler water, watch both temperatures with a heat camera, count where the energy goes, and work out which way the heat travels.',
  safety: [
    'A potato from boiling water can scald long after the pot is off the heat. Only an adult lifts it, with tongs.',
    'Keep the thermometer upright, with its tip in the water and off the bottom of the beaker.',
  ],
  sim: { page: 'labs/hot-potato/index.html', label: "Let's test it now!", covers: ['a', 'b', 'c'], map: { a: 'camera', b: 'energy', c: 'flow' } },
  badge: { icon: '🥔', name: 'Heat Tracker', line: 'You followed the heat out of the hot potato, into the water, and found where it stopped.' },
  parts: [
    {
      id: 'a', title: 'Watching both temperatures', who: 'adult demonstration',
      need: ['a hot potato', 'a beaker of cool water', 'two thermometers', 'a clock'],
      steps: [
        { do: 'A potato has been sitting in boiling water. Beside it stands a beaker of cool water. One thermometer is in the potato, one in the water.' },
        { predict: { q: 'The hot potato is lowered into the cool water. What happens to the two temperatures?', options: ['The potato cools down and the water warms up', 'Both get hotter', 'Nothing changes until the potato is lifted out'], answer: 0 } },
        { do: 'On the bench, turn on the heat camera and lower the potato in. Watch both numbers for twenty minutes.' },
        ...
        { observe: { q: 'After a long wait, what did the two readings do?', options: ['They met at the same temperature', 'The potato stayed hotter for ever', 'The water ended up hotter than the potato'], answer: 0 } },
        { explain: { q: 'Describe what happened to the temperature of the potato and to the temperature of the water after the potato was lowered in.',
          concept: 'The hotter object loses heat and cools; the colder object gains heat and warms; both end at the same temperature.',
          model: 'The potato was hotter, so it lost heat and its temperature fell. The water was colder, so it gained heat and its temperature rose. They kept changing until both were at the same temperature, and then they stopped changing.',
          points: [ { point: 'the potato loses heat, so its temperature falls', marks: 1 }, { point: 'the water gains heat, so its temperature rises', marks: 1 }, { point: 'both stop changing once they reach the same temperature', marks: 1 } ],
          doNotAccept: ['the potato gives out coldness', 'the water pushes heat into the potato'] } },
        { note: 'On the heat camera, hotter shows brighter. You can watch the brightness leave the potato and spread into the water.' },
      ],
    },
    {
      id: 'b', title: 'Counting the energy', who: 'hands on',
      need: ['the bench in energy view', 'a table with two columns for the counters'],
      steps: [
        { do: 'The bench can show the heat as counters: how much is in the potato, and how much is in the water.' },
        { predict: { q: 'As the potato loses ten counters of heat, what happens to the water?', options: ['It gains about ten counters', 'It gains nothing', 'It loses counters too'], answer: 0 } },
        { do: 'Switch the bench to energy view. Read both counters at the start, in the middle, and at the end.' },
        { observe: { q: 'What did the two counters do?', options: ['One went down as the other went up', 'Both went down', 'Both went up'], answer: 0 } },
        { observe: { q: 'What happened to the two counters added together?', options: ['It stayed about the same', 'It doubled', 'It fell to nothing'], answer: 0 } },
        { explain: { q: 'Where did the heat that the potato lost go? Use the counters in your answer.',
          concept: 'Heat is transferred from the hotter object to the colder one; it is not destroyed.',
          model: 'It went into the water. Every counter the potato lost showed up in the water, so the two counters added together stayed about the same. The heat moved from the potato to the water instead of disappearing.',
          points: [ { point: 'the heat went from the potato into the water', marks: 1 }, { point: 'what the potato lost, the water gained, so the total stayed about the same', marks: 1 } ],
          doNotAccept: ['the heat vanished', 'the heat was used up by the potato'] } },
        { note: 'Left alone for long enough, the pair slowly loses heat to the room as well, because the room is colder than they are.' },
      ],
    },
    {
      id: 'c', title: 'Which way does heat travel?', who: 'hands on',
      need: ['the bench in flow view'],
      steps: [
        { do: 'The bench can draw arrows for the heat moving between the potato and the water.' },
        { predict: { q: 'Which way will the arrows point while the potato is still hotter than the water?', options: ['From the potato to the water', 'From the water to the potato', 'Both ways, equally'], answer: 0 } },
        { do: 'Switch the bench to flow view. Try both arrow directions and watch what the temperatures do. Then wait until the readings meet.' },
        { observe: { q: 'Which arrow matched what the temperatures were doing?', options: ['Potato to water', 'Water to potato', 'Neither'], answer: 0 } },
        { observe: { q: 'Once both readings were the same, what happened to the arrows?', options: ['They stopped', 'They swapped direction', 'They got bigger'], answer: 0 } },
        { explain: { q: 'State the rule for which way heat moves between two objects that are touching, and say when the moving stops.',
          concept: 'Heat flows from the hotter object to the colder object until both reach the same temperature.',
          model: 'Heat always moves from the hotter object to the colder object. Here it moved from the potato to the water. It keeps moving until both objects are at the same temperature, and then it stops.',
          points: [ { point: 'heat moves from the hotter object to the colder object', marks: 1 }, { point: 'it stops when both are at the same temperature', marks: 1 } ],
          doNotAccept: ['heat moves both ways at once', 'cold moves into the potato'] } },
        { note: 'Nothing ever moves the other way on its own. A colder thing cannot push heat into a hotter one.' },
      ],
    },
  ],
  conclude: [
    { text: 'Heat moves from the ___ object to the ___ object.', answers: ['hotter', 'colder'] },
    { text: 'An object that loses heat becomes ___.', answers: ['cooler'] },
    { text: 'An object that gains heat becomes ___.', answers: ['warmer'] },
    { text: 'Heat stops moving when both objects are at the same ___.', answers: ['temperature'] },
  ],
  check: [
    { q: 'A cold metal spoon is left standing in a mug of hot soup. Explain what happens to the temperature of the spoon and to the temperature of the soup, and what happens in the end.',
      marks: 3, concept: 'Heat flows from the hotter soup to the colder spoon until both are at the same temperature.',
      model: 'The soup is hotter, so it loses heat and cools down. The spoon is colder, so it gains heat and warms up. They keep changing until the spoon and the soup are at the same temperature, and then they stop.',
      points: [ { point: 'the soup loses heat and cools', marks: 1 }, { point: 'the spoon gains heat and warms', marks: 1 }, { point: 'they stop changing at the same temperature', marks: 1 } ],
      doNotAccept: ['the spoon makes the soup cold', 'coldness travels up the spoon'] },
    { q: 'A glass of iced water is left on a table in a warm room. Explain why it slowly warms up.',
      marks: 2, concept: 'The warmer room gives heat to the colder drink until the drink reaches room temperature.',
      model: 'The air in the room is hotter than the iced water, so heat moves from the room into the glass and the water warms up. It keeps warming until it is at the same temperature as the room.',
      points: [ { point: 'the room is hotter than the drink, so heat moves from the room into the drink', marks: 1 }, { point: 'it stops warming once it reaches room temperature', marks: 1 } ],
      doNotAccept: ['the cold escapes from the glass', 'the ice pulls in heat to survive'] },
  ],
},
];
