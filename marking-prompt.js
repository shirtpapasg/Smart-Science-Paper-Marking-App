...
export function buildMcqUser(questionText, syllabusTopics, exclusions) {
  return [
    ...
    '  name, plain is ONE sentence saying what it does and, if it is a wrong',
    '  option, what it cannot do. Write plain for a parent with no science',
    '  background: no syllabus terms, no phrases like "volume of an irregular',
    '  solid". Empty array when the question has no such items.',
